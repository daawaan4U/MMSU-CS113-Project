...
public class WeatherForecastPanel extends JPanel {
     ...
     *
     * @param forecastData The new weather forecast data.
     */
    private void updateForecast(WeatherForecast5Data forecastData) {
        ...
        // Limit the forecast to 5 days, with each day having 8 data points (3-hour intervals)
        ...
        for (int i = 0; i < dayCount; i++) {
            ...
            // Get the iconId for the day (assuming the first entry of the day has the relevant icon)
            ...
            // Calculate the average temperature for the day, converting from Kelvin to Celsius
            float sumTemp = 0;
